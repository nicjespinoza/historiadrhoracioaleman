...
import { Users, UserPlus, Search, ArrowLeft, Trash2, AlertTriangle, X, ChevronLeft, ChevronRight } from 'lucide-react';
                        ...
                        <div key={p.id} className="bg-white p-6 rounded-2xl shadow-sm border-2 border-black hover:shadow-md transition-all group relative overflow-hidden">
                            <div className="flex justify-between items-start">
                                <div>
                                    ...
                                    <span className="text-[10px] font-bold tracking-wider text-gray-400 mt-3 inline-block bg-gray-50 px-2 py-1 rounded">ID: {p.id?.slice(0, 8)}...</span>
                                </div>
